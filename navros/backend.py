...
class Backend:
    def __init__(self, device: str, precision: str, xla_cache: str | None = None):
        ...
        if self.is_xla:
            ...
            self.n_dev = xr.global_runtime_device_count()
    ...
    def shard_param(self, p):
        if self.is_xla and p.ndim == 2 and p.shape[0] % self.n_dev == 0:
